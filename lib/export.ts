...
export function resultToMarkdown(result: CheckResult): string {
  ...
  lines.push(`# Proofbase Scan Report`);
  lines.push(``);
  ...
  lines.push(`---`);
  lines.push(
    `_Generated by Proofbase. Source Quality Score reflects outlet credibility, not truth. Always verify with primary sources._`
  );
